                ...
                <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                    ...
                    <ul class="chat-list">
                        <li class="list active">
                            <div class="profile"><img src="{{asset("backend/template/images/faces/face1.jpg")}}" alt="image"><span class="online"></span></div>
                            <div class="info">
                                <p>Thomas Douglas</p>
                                <p>Available</p>
                            </div>
                        ...
                        <li class="list">
                            <div class="profile"><img src="{{asset("backend/template/images/faces/face2.jpg")}}" alt="image"><span class="offline"></span></div>
                            <div class="info">
                        ...
                        <li class="list">
                            <div class="profile"><img src="{{asset("backend/template/images/faces/face3.jpg")}}" alt="image"><span class="online"></span></div>
                            <div class="info">
                                <p>Daniel Russell</p>
                                <p>Available</p>
                            </div>
...
<script src="{{asset("backend/template/vendors/chart.js/Chart.min.js")}}"></script>
<script src="{{asset("backend/template/vendors/datatables.net/jquery.dataTables.js")}}"></script>
<script src="{{asset("backend/template/vendors/datatables.net-bs4/dataTables.bootstrap4.js")}}"></script>
<script src="{{asset("backend/template/js/dataTables.select.min.js")}}"></script>

<!-- End plugin js for this page -->
<!-- inject:js -->
<script src="{{asset("backend/template/js/off-canvas.js")}}"></script>
<script src="{{asset("backend/template/js/hoverable-collapse.js")}}"></script>
...
<script src="{{asset("backend/template/js/dashboard.js")}}"></script>
<script src="{{asset("backend/template/js/Chart.roundedBarCharts.js")}}"></script>
