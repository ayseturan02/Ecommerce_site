        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route("panel.slider.update")}}" class="forms-sample" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slogan"  name="content" value="{{$slider->content ?? "" }}" placeholder="Slider slogan">
                        </div>
                        <div class="form-group">
